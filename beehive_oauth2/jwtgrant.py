...
class JwtGrant(GrantTypeBase):
    ...
    def __init__(self, request_validator=None, **kwargs):
        ...
        self.controller = request_validator.controller
        ...
        try:
            ...
            if not self.request_validator.authenticate_client(request):
                ...
                if not hasattr(request.client, 'client_id'):
                    raise NotImplementedError('Authenticate client must set the request.client.client_id attribute '
...
class JwtApplicationServer(TokenEndpoint, ResourceEndpoint, RevocationEndpoint):
    ...
    def __init__(self, request_validator, token_generator=None, token_expires_in=None, **kwargs):
        ...
        TokenEndpoint.__init__(self, default_grant_type=GrantType.JWT_BEARER,
