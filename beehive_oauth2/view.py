...
class Oauth2ApiView(SwaggerApiView):
    ...
    def authorize_error(self, redirect_uri, error, state, error_description=None, error_uri=None):
    ...
    def check_login(self, controller: Oauth2Controller, format_json=False):
        # check login
...
class GetAuthorizationScope(Oauth2ApiView):
    tags = ["oauth2"]
    definitions = {}
    responses = {200: {"description": "return html select scopes page"}}
...
class SetAuthorizationScope(Oauth2ApiView):
    ...
    responses = {302: {"description": "redirect to /oauth2/authorize?.. if user authorize" "access to scopes lost"}}

    def post(self, controller: Oauth2Controller, data: Dict, *args, **kwargs):
        """
        Set user scopes
        ...
        body, status, headers = controller.create_authorization(
            uri, http_method, body, headers, scopes, session_credentials
        )
        return Response(body, status=status, headers=headers), status
...
class CreateAccessToken(Oauth2ApiView):
    tags = ["oauth2"]
    definitions = {"CreateAccessTokenResponseSchema": CreateAccessTokenResponseSchema}
    ...
    def post(self, controller: Oauth2Controller, data: Dict, *args, **kwargs):
        ...
        body, status, headers = controller.create_token(uri, http_method, body, headers, session, login_ip)
...
class LoginPage(SwaggerApiView):
    tags = ["oauth2"]
    definitions = {}
    responses = {200: {"description": "return html login page"}}
...
class Logout(SwaggerApiView):
    tags = ["oauth2"]
    definitions = {}
    responses = {200: {"description": "return html logout page"}}
    ...
    def get(self, controller, data, *args, **kwargs):
        ...
        self.response_mime = "text/html"
        resp = (
            render_template("logout.html", user=user, style=url_for("static", filename=style)),
            200,
        )
        return resp
...
class UserPage(SwaggerApiView):
    tags = ["oauth2"]
    definitions = {}
    responses = {200: {"description": "return html user page"}}
...
class ListClients(SwaggerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListClientsResponseSchema}})
...
class GetClient(SwaggerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetClientResponseSchema}})
...
class UpdateClient(SwaggerApiView):
    ...
    def put(self, controller: Oauth2Controller, data: Dict, oid, *args, **kwargs):
        """
        Update client
...
class ListScopes(SwaggerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListScopesResponseSchema}})
...
class GetScope(SwaggerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetScopeResponseSchema}})
